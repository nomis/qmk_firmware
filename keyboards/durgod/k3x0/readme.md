...
This is a standard off-the-shelf Durgod Taurus K3X0 keyboard without backlight.
This supports both the ANSI and ISO variants of both the K310 full-sized
104/105-key and K320 TKL 87/88-key keyboards.

* Keyboard Maintainer: [dkjer](https://github.com/dkjer) and [tylert](https://github.com/tylert)
...
Make command example for this keyboard (after setting up your build environment):
    ...
    make durgod/k3x0:default

Flashing example for this keyboard:

    make durgod/k3x0:default:flash
...
<img src="https://i.imgur.com/hvDnw5a.jpg" width="520" height="693" alt="Shorting Boot0 to Vdd on K3X0">
