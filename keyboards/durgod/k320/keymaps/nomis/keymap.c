...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_FUNC] = LAYOUT_tkl_iso( /* Function Layer */
      ...
      _______,  _______,  _______,  KC_MAIL,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PWR,   _______,  _______,            _______,  KC_MUTE,  KC_VOLD,
      ...
      _______,  CK_TGUI,  _______,                                _______,                                _______,  KC_APP,   _______,  _______,  KC_MRWD,  _______,  KC_MFFD
  ),
